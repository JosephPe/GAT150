...
namespace anthemum
{
	...
	public:
		...
		Vector2 operator + (const Vector2& v) const { return Vector2{ v.x + this->x, v.y + this->y}; }
		Vector2 operator - (const Vector2& v) const { return Vector2{ v.x - this->x, v.y - this->y}; }
		Vector2 operator * (const Vector2& v) const { return Vector2{ v.x * this->x, v.y * this->y}; }
		Vector2 operator / (const Vector2& v) const { return Vector2{ v.x / this->x, v.y / this->y}; }
		...
		Vector2 operator + (float s) const { { return Vector2{ s + this->x, s + this->y }; } }
		Vector2 operator - (float s) { { return Vector2{ s - this->x, s - this->y }; } }
		Vector2 operator * (float s) { { return Vector2{ s * this->x, s * this->y }; } }
		Vector2 operator / (float s) { { return Vector2{ s / this->x, s / this->y }; } }
		...
		//Vector2 Add(const Vector2& v) { return Vector2{} }
